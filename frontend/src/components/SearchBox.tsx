    ...
    <div className="flex flex-row relative items-center justify-center h-10">
      ...
      <form className="h-full" onSubmit={(e) => e.preventDefault()}>
        <input
          ...
          className="px-4 py-2 w-56 border border-gray-400 rounded-l-md focus:outline-none focus:border-blue-600 h-full bg-gray-800 text-white placeholder-gray-400 transition duration-300 group hover:bg-gray-700"
        />
      </form>
